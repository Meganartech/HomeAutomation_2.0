...
export default function LoggedInNavbar({ path }) {
                    ...
                    CDx/rY4HEfEEoM8AWY0l4OHh4eHh4RGsVfwPP+3PPBW7WDgAAAAASUVORK5CYII=" alt="logo" className="mb-1" />
                        ...
                        <div className="offcanvas-body justify-content-end">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item pe-md-3 mb-1">
                                    <Link className={`nav-link nav-link-hover text-D4C9BE ${location.pathname === path ? "active-D4C9BE" : ""} `} to={path}>Dashboard</Link>
                                </li>
                                <li className="nav-item pe-md-3 mb-1">
                                    <Link className="nav-link nav-link-hover text-D4C9BE" onClick={() => { localStorage.removeItem("token"); navigate("/"); }} to="/">Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
