...
export default function KitchenContent({ onRoomAdded }) {

    const [showAddRoomModal, setShowAddRoomModal] = useState(false);
    const [roomName, setRoomName] = useState('');

    const devices = [
        { name: 'Ambient Smart Lights', room: 'Kitchen', power: '45KWh', status: true },
        { name: 'Smart Air Purifier', room: 'Kitchen', power: '45KWh', status: false },
        { name: 'Smart Light Strip', room: 'Kitchen', power: '45KWh', status: true },
        { name: 'Smart Thermostat', room: 'Kitchen', power: '45KWh', status: false }
    ];
        ...
        <>
            <div className="container px-5 py-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <div style={{ fontSize: '24px', lineHeight: '100%', letterSpacing: '0' }}>Kitchen</div>
