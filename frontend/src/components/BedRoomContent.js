...
export default function BedRoomContent({ onRoomAdded }) {

    const [showAddRoomModal, setShowAddRoomModal] = useState(false);
    const [roomName, setRoomName] = useState('');

    const devices = [
        { name: 'Ambient Smart Lights', room: 'Bed room', power: '45KWh', status: true },
        { name: 'Smart Air Purifier', room: 'Bed Room', power: '45KWh', status: false },
        { name: 'Smart Light Strip', room: 'Bed room', power: '45KWh', status: true },
        { name: 'Smart Thermostat', room: 'Bed room', power: '45KWh', status: false }
    ];
        ...
        <>
            <div className="container px-5 py-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <div style={{ fontSize: '24px', lineHeight: '100%', letterSpacing: '0' }}>Bed Room</div>
