...
export default function HallContent({ onRoomAdded }) {

    const [showAddRoomModal, setShowAddRoomModal] = useState(false);
    const [roomName, setRoomName] = useState('');

    const devices = [
        { name: 'Ambient Smart Lights', room: 'Hall', power: '45KWh', status: true },
        { name: 'Smart Air Purifier', room: 'Hall', power: '45KWh', status: false },
        { name: 'Smart Light Strip', room: 'Hall', power: '45KWh', status: true },
        { name: 'Smart Thermostat', room: 'Hall', power: '45KWh', status: false }
    ];
        ...
        <>
            <div className="container px-5 py-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <div style={{ fontSize: '24px', lineHeight: '100%', letterSpacing: '0' }}>Hall</div>
